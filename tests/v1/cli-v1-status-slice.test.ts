...
function createVaultWithSlice(options: SliceFixtureOptions) {
  ...
  if (options.evidence?.length) frontmatter.v1_evidence = options.evidence;
...
function passingEvidence() {
  return [
    { kind: "tdd", command: "bun test tests/v1/status.test.ts", result: "passed", recordedAt: "2026-04-28T06:00:00.000Z" },
...
describe("v1 slice-specific forge status", () => {
  ...
  test("reports close-ready slices when V1 evidence satisfies gates", () => {
