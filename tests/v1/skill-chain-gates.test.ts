...
import { buildSkillChainPacket, getDefaultSkillChain } from "../../src/v1/forge/skill-chain";
import { isPhaseSkippable } from "../../src/v1/forge/phase";
import { validatePhaseCompletion, validatePhaseTransition } from "../../src/v1/forge/phase-gates";

describe("v1 skill chain gates", () => {
