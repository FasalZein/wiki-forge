...
import type { AcceptedChangeSet, ChangeSetDraft } from "../../src/v1/kernel/changeset";
import { inspectChangeSetReadiness } from "../../src/v1/kernel/changeset";
import type { KernelIntent } from "../../src/v1/kernel/intent";
import { acceptKernelIntent, rejectKernelIntent } from "../../src/v1/kernel/result";
import {
  KERNEL_REJECTION_CODES,
  createKernelRejection,
  getKernelRejectionRecoveryCommands,
} from "../../src/v1/kernel/rejection";
...
describe("v1 kernel intent/result primitives", () => {
