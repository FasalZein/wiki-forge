...
import { DEFAULT_ASK_MAX_RESULTS } from "./answer-request";

const DEFAULT_ASK_CANDIDATES = 8;

export { DEFAULT_ASK_MAX_RESULTS };

export async function buildAnswerBrief(options: AskOptions): Promise<AnswerBrief> {
