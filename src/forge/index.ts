...
import { forgeCheck, forgeClose, forgeEvidence, forgeNext, forgeOpen, forgePlan, forgeRelease, forgeRun, forgeSkip, forgeStart, forgeStatus } from "../slice/forge";
...
export function resolveForgeCommand(rest: string[]) {
  ...
  }[subcommand as "start" | "open" | "check" | "close" | "run" | "skip" | "evidence" | "status" | "plan" | "next" | "release"];
