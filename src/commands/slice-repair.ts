...
export async function readDoneSliceDocs(project: string, taskId: string) {
...
export function inferHistoricalCompletedAt(docs: Array<{ data: Record<string, unknown> }>) {
...
export function collectDoneSliceRepairChanges(docs: Array<{ data: Record<string, unknown>; kind: "index" | "plan" | "test-plan" }>) {
...
export function normalizeDoneSliceDoc(
...
export function classifyArchiveCandidate(taskId: string, completedAt: string) {
