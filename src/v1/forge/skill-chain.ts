...
export type SkillChainPacket = {
  readonly nextPhase: V1ForgePhase | null;
  readonly requiredSkill: string | null;
  readonly chain: readonly V1SkillChainEntry[];
};

const DEFAULT_SKILL_CHAIN: readonly V1SkillChainEntry[] = [
...
export function getDefaultSkillChain(): readonly V1SkillChainEntry[] {
