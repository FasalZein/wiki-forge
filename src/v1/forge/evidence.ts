export type V1EvidenceResult = "passed" | "failed";

export type TddEvidenceRecord = {
  readonly kind: "tdd";
  readonly command: string;
  readonly result: V1EvidenceResult;
...
export type V1EvidenceRecord = TddEvidenceRecord | VerificationEvidenceRecord | ReviewEvidenceRecord | ClosureEvidenceRecord;
