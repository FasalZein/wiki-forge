import type { ProjectRecord, SliceRecord, V1Diagnostic, VaultDocument } from "./document";
...
export type LegacyClassification =
  ...
  | { readonly status: "repairable"; readonly canonical: false; readonly diagnostics: readonly V1Diagnostic[] }
  | { readonly status: "quarantined"; readonly canonical: false; readonly reason: string; readonly diagnostics: readonly V1Diagnostic[] }
