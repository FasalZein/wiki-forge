...
const COMMAND_SURFACE = [
  ...
  entry(["note", "log"], "wiki-memory", "V1 typed project memory entries that do not mutate Forge lifecycle.", { v1Handler: "v1:memory" }),
  entry(["export-prompt"], "wiki-memory", "V1 prompt packet rendered from handover memory and Forge status truth.", { v1Handler: "v1:export-prompt" }),
  ...
  entry(["v1", "v1:forge:next", "v1:forge:status", "v1:forge:plan", "v1:forge:start", "v1:forge:release", "v1:forge:amend", "v1:forge:check", "v1:forge:close", "v1:forge:run", "v1:forge:evidence", "v1:forge:review", "v1:handover", "v1:resume", "v1:export-prompt", "v1:note", "v1:log", "v1:compat"], "admin-view", "Explicit V1/internal command namespace."),
