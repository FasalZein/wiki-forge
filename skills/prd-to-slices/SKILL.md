...
For wiki-forge projects, preserve upstream tracer-bullet slicing. Publish approved slices through `wiki forge plan`; implementation proceeds through Forge status/start, `/tdd`, targeted verification, review, and close. External issue trackers are pointers only unless requested.
